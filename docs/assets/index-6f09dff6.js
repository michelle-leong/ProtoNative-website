 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,$){var z=P.length;P.push($);e:for(;0<z;){var ee=z-1>>>1,le=P[ee];if(0<o(le,$))P[ee]=$,P[z]=le,z=ee;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var $=P[0],z=P.pop();if(z!==$){P[0]=z;e:for(var ee=0,le=P.length,Qr=le>>>1;ee<Qr;){var Vt=2*(ee+1)-1,nl=P[Vt],Qt=Vt+1,Yr=P[Qt];if(0>o(nl,z))Qt<le&&0>o(Yr,nl)?(P[ee]=Yr,P[Qt]=z,ee=Qt):(P[ee]=nl,P[Vt]=z,ee=Vt);else if(Qt<le&&0>o(Yr,z))P[ee]=Yr,P[Qt]=z,ee=Qt;else break e}}return $}function o(P,$){var z=P.sortIndex-$.sortIndex;return z!==0?z:P.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var u=[],s=[],p=1,m=null,h=3,w=!1,g=!1,v=!1,N=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(P){for(var $=n(s);$!==null;){if($.callback===null)r(s);else if($.startTime<=P)r(s),$.sortIndex=$.expirationTime,t(u,$);else break;$=n(s)}}function y(P){if(v=!1,d(P),!g)if(n(u)!==null)g=!0,el(x);else{var $=n(s);$!==null&&tl(y,$.startTime-P)}}function x(P,$){g=!1,v&&(v=!1,f(T),T=-1),w=!0;var z=h;try{for(d($),m=n(u);m!==null&&(!(m.expirationTime>$)||P&&!Ce());){var ee=m.callback;if(typeof ee=="function"){m.callback=null,h=m.priorityLevel;var le=ee(m.expirationTime<=$);$=e.unstable_now(),typeof le=="function"?m.callback=le:m===n(u)&&r(u),d($)}else r(u);m=n(u)}if(m!==null)var Qr=!0;else{var Vt=n(s);Vt!==null&&tl(y,Vt.startTime-$),Qr=!1}return Qr}finally{m=null,h=z,w=!1}}var E=!1,S=null,T=-1,U=5,L=-1;function Ce(){return!(e.unstable_now()-L<U)}function St(){if(S!==null){var P=e.unstable_now();L=P;var $=!0;try{$=S(!0,P)}finally{$?Wt():(E=!1,S=null)}}else E=!1}var Wt;if(typeof c=="function")Wt=function(){c(St)};else if(typeof MessageChannel<"u"){var Bn=new MessageChannel,bi=Bn.port2;Bn.port1.onmessage=St,Wt=function(){bi.postMessage(null)}}else Wt=function(){N(St,0)};function el(P){S=P,E||(E=!0,Wt())}function tl(P,$){T=N(function(){P(e.unstable_now())},$)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){g||w||(g=!0,el(x))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(P){switch(h){case 1:case 2:case 3:var $=3;break;default:$=h}var z=h;h=$;try{return P()}finally{h=z}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,$){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var z=h;h=P;try{return $()}finally{h=z}},e.unstable_scheduleCallback=function(P,$,z){var ee=e.unstable_now();switch(typeof z=="object"&&z!==null?(z=z.delay,z=typeof z=="number"&&0<z?ee+z:ee):z=ee,P){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=z+le,P={id:p++,callback:$,priorityLevel:P,startTime:z,expirationTime:le,sortIndex:-1},z>ee?(P.sortIndex=z,t(s,P),n(u)===null&&P===n(s)&&(v?(f(T),T=-1):v=!0,tl(y,z-ee))):(P.sortIndex=le,t(u,P),g||w||(g=!0,el(x))),P},e.unstable_shouldYield=Ce,e.unstable_wrapCallback=function(P){var $=h;return function(){var z=h;h=$;try{return P.apply(this,arguments)}finally{h=z}}}})(Xc);(function(e){e.exports=Xc})(p0);/**
 * @license React
...
`;function H1({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=bu,iterationCount:o=1}){return zp`
  ...
  `}function U1(e){return e==null}function B1(e){return typeof e=="string"||typeof e=="number"||typeof e=="boolean"}function jp(e,t){return n=>n?e():t()}function ai(e){return jp(e,()=>null)}var Dp=e=>{const{cascade:t=!1,damping:n=.5,delay:r=0,duration:o=1e3,fraction:i=0,keyframes:l=bu,triggerOnce:a=!1,className:u,style:s,childClassName:p,childStyle:m,children:h,onVisibilityChange:w}=e,g=M.useMemo(()=>H1({keyframes:l,duration:o}),[o,l]);return U1(h)?null:B1(h)?ae(V1,{...e,animationStyles:g,children:String(h)}):Fa.isFragment(h)?ae(Fp,{...e,animationStyles:g}):ae(T1,{children:M.Children.map(h,(v,N)=>{if(!M.isValidElement(v))return null;const f=r+(t?N*o*n:0);switch(v.type){case"ol":case"ul":return ae(Il,{children:({cx:c})=>ae(v.type,{...v.props,className:c(u,v.props.className),style:Object.assign({},s,v.props.style),children:ae(Dp,{...e,children:v.props.children})})});case"li":return ae(Fc,{threshold:i,triggerOnce:a,onChange:w,children:({inView:c,ref:d})=>ae(Il,{children:({cx:y})=>ae(v.type,{...v.props,ref:d,className:y(p,v.props.className),css:ai(()=>g)(c),style:Object.assign({},m,v.props.style,{animationDelay:f+"ms"})})})});default:return ae(Fc,{threshold:i,triggerOnce:a,onChange:w,children:({inView:c,ref:d})=>ae("div",{ref:d,className:u,css:ai(()=>g)(c),style:Object.assign({},s,{animationDelay:f+"ms"}),children:ae(Il,{children:({cx:y})=>ae(v.type,{...v.props,className:y(p,v.props.className),style:Object.assign({},m,v.props.style)})})})})}})})},W1={display:"inline-block",whiteSpace:"pre"},V1=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:o=0,duration:i=1e3,fraction:l=0,triggerOnce:a=!1,className:u,style:s,children:p,onVisibilityChange:m}=e,{ref:h,inView:w}=Rp({triggerOnce:a,threshold:l,onChange:m});return jp(()=>ae("div",{ref:h,className:u,style:Object.assign({},s,W1),children:p.split("").map((g,v)=>ae("span",{css:ai(()=>t)(w),style:{animationDelay:o+v*i*r+"ms"},children:g},v))}),()=>ae(Fp,{...e,children:p}))(n)},Fp=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:o,style:i,children:l,onVisibilityChange:a}=e,{ref:u,inView:s}=Rp({triggerOnce:r,threshold:n,onChange:a});return ae("div",{ref:u,className:o,css:ai(()=>t)(s),style:i,children:l})};_`
  from,
  20%,
  40%,
  60%,
...
`;const ig=({index:e,title:t,description:n,img:r,gif:o})=>{const i=o?"gif":"picture";return se("div",{className:"feature",children:[e%2===0?O(Aa,{direction:"left",children:se("div",{id:"feature-title-desc",className:"feature-text",children:[O("h2",{children:t}),O("p",{children:n})]})}):null,O("img",{id:"gif",className:i,src:r}),e%2===1?O(Aa,{direction:"right",children:se("div",{className:"feature-text",children:[O("h2",{children:t}),O("p",{children:n})]})}):null]})},lg=()=>{const t=[{title:"Create Layouts on the App Canvas",description:"Add elements to app canvas and custom component details to create a layout of your application. Elements that allow nesting will highlight in yellow upon hovering an element. Remove elements by dragging them to the trash area. The code preview will be updated as elements are added and removed!",img:"https://raw.githubusercontent.com/oslabs-beta/ProtoNative/readme/gifs/canvas-elements.gif",gif:!0},{title:"Stateful Components",description:"Make a components stateful by pressing the State button next to it. Add and delete states in the modal.",img:"https://raw.githubusercontent.com/oslabs-beta/ProtoNative/readme/gifs/Add-state-to-components.gif",gif:!0},{title:"Nested Custom Components",description:"Custom Components can be children of other custom components. These parent-child relationships will be reflected in the App Canvas as you customize your components.",img:"https://raw.githubusercontent.com/oslabs-beta/ProtoNative/readme/gifs/Add-reuseable-components-as-child.gif",gif:!0},{title:"Tree Hierarchy",description:"Visualize your project by pressing the tree tab. Display states of a stateful component by pressing the info button! The tree is easily customizable to a user's preference. Nodes are easily repositioned by dragging and the orientation of the tree can be switched by pressing the arrow key in the bottom right.",img:"./demo-pictures/tree-hierarchy.png",gif:!1},{title:"Export your Project",description:"Once you're finished with your project, export it to your local machine using the export button! The resulting folder contains all of your custom components, app, and package.json/app.json, all properly structured. Make sure to run 'npm install' before starting your app, and your project will be ready to go!",img:"https://raw.githubusercontent.com/oslabs-beta/ProtoNative/readme/gifs/export.gif",gif:!0}].map((n,r)=>O(ig,{index:r,title:n.title,description:n.description,img:n.img,gif:n.gif},r));return se("div",{id:"features-container",children:[O("h1",{children:"Features"}),t]})},ag=()=>se("div",{id:"landing",children:[se("div",{id:"main-logo-container",children:[O("div",{id:"main-img-container",children:O("img",{id:"main-logo",src:"./icons/logo-word.png"})}),O("div",{id:"main-logo-glow"})]}),O("h1",{children:"ProtoNative is a React Native Prototyping Tool for mobile developers. With its seamless drag-and-drop interface, live code preview, and much, much more, ProtoNative is your all-in-one tool for all things React Native."}),se("div",{id:"downloads-container",children:[O("a",{href:"./downloads/ProtoNative-Setup-1.0.0.exe",download:!0,children:O("button",{className:"download",children:se("div",{className:"download-content",children:[O("div",{className:"download-img-container",children:O("img",{src:"./icons/windows-logo.png"})}),O("p",{children:"Download for Windows"})]})})}),O("a",{href:"",children:O("button",{className:"download",children:se("div",{className:"download-content",children:[O("div",{className:"download-img-container",children:O("img",{src:"./icons/apple-logo.png"})}),O("p",{children:"Download for Mac"})]})})})]})]}),ug=({name:e,img:t,github:n,linkedin:r})=>se("div",{className:"team-card",children:[O("img",{className:"profile",src:t}),O("h3",{children:e}),O("p",{children:"Software Engineer"}),se("div",{className:"links",children:[O("a",{href:n,children:O("img",{src:"./icons/github.svg"})}),O("a",{href:r,children:O("img",{src:"./icons/linkedin.svg"})})]})]}),sg=()=>{const t=[{name:"Jonathan Klibansky",img:"./profiles/jonathan.jpg",github:"https://github.com/jon19200",linkedin:"https://linkedin.com/in/jonathanklibansky"},{name:"Matthew Kymn",img:"./profiles/matt.png",github:"https://github.com/mkymn10",linkedin:"https://linkedin.com/in/mkymn10"},{name:"Michelle Leong",img:"./profiles/michelle.png",github:"https://github.com/michelle-leong",linkedin:"https://linkedin.com/in/michelle-w-leong"},{name:"Raymond Ferrer",img:"./profiles/raymond.jpg",github:"https://github.com/rnferrer",linkedin:"https://linkedin.com/in/rnferrer"},{name:"Patricia Good",img:"./profiles/patricia.png",github:"https://github.com/pkg415",linkedin:"https://linkedin.com/in/patricia-g415"}].map((n,r)=>O(ug,{name:n.name,img:n.img,github:n.github,linkedin:n.linkedin},r));return O("div",{id:"team-section",children:se(Aa,{cascade:!0,children:[O("h1",{children:"Meet the Team"}),O("div",{id:"team-container",children:t})]})})},cg=()=>se("div",{id:"main-container",children:[O(ag,{}),O(lg,{}),O(sg,{})]});const fg=()=>se("div",{children:[O(Sy,{}),O(cg,{})]});Kd(document.getElementById("root")).render(O(fg,{}));
